...
//   void initState() {
//     super.initState();
//     riskRatingController.sink.add(risk);
//   }
...
//     if(snapshot.hasData){
//       riskImpactController.text = (snapshot.data!.riskImpact != null)?snapshot.data!.riskImpact.toString():'';
//       riskExposureController.text = (snapshot.data!.riskExposure !=null)?snapshot.data!.riskExposure.toString():'';
...
//         subheading: 'RISK IMPACT (\$)', text:(snapshot.data!.riskImpact != null)? '\$ ${snapshot.data!.riskImpact.toString()}':''),
//     RiskInfoSubHeadingAndText(
//         subheading: 'RISK EXPOSURE (\$)', text:(snapshot.data!.riskExposure != null)? '\$ ${snapshot.data!.riskExposure.toString()}':''),
//                   ],
//                 ),
//               ),
//             ),
