...
import 'package:erm/Pages/settings/widgets/business_settings_widgets/add_business_entity.dart';
import 'package:erm/Pages/settings/widgets/business_settings_widgets/business_entities_table.dart';
                    ...
                    Expanded(
                      child: Padding(
                          ...
                          child: Container(
                              ...
                              child: (showAddUser == false)
                                  ? BusinessEntitiesTable(data: data)
