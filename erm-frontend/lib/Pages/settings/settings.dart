import 'package:erm/Pages/settings/widgets/business_settings_widgets/business_settings.dart';
              ...
              children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          selectedTileColor:
                              const Color.fromARGB(26, 2, 82, 143),
                          selected: (activeTab == 0) ? true : false,
                          leading:
                              Icon(Icons.person, size: 22, color: tileColor),
                          title: const Text(
                            'My Profile',
                            style: TextStyle(
                                color: Colors.black54,
                ...
                Column(
                  ...
                  children: [
                    ListTile(
                      leading:
                          Icon(Icons.headphones, size: 22, color: tileColor),
                      title: const Text(
                        'Support',
                        style: TextStyle(
                            color: Colors.black54,
