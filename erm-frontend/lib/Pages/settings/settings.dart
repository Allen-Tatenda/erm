...
List<Widget> settingsPages = [const MyProfilePage(),const NotificationSettings(),const PasswordSettings()];
                  ...
                  children: [
                    Column(
                        ...
                        Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: Text('PERSONAL',style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w800),),
                            ),
                            ListTile(
                              onTap: (){
                                 setState(() {
                      ...
                      children: [
                        const Padding(
                          padding: EdgeInsets.fromLTRB(10, 16, 0, 0),
                          child: Text('Account',style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w800),),
                        ),
                        ListTile(
                          onTap: (){
                                 setState(() {
